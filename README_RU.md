Отлично! Я обновил русскую версию README_RU.md, чтобы она полностью соответствовала вашему новому стеку с JWT, Refresh Tokens и Redis.
...
- Аутентификация теперь происходит путем отправки JWT Bearer Token в заголовке Authorization.
